...
# from inference_engine.onestep.inference_engine.linker import get_node_knowledge
...
1. Each code line should among instantiate a node, invoke a node and connect a node. You should not invoke a node before it is instantiated.
