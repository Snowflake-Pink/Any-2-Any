for TASK in "image_inpaint" "image_merge" "image_outpaint" "image_view_inference" "image_with_merged_models" "image2mesh"\
            "image2multiview_image" "image2video" "text2audio" "text2image" "text2mesh" "text2video";
do
